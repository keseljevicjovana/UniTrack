...
function App() {
  return (
    <Routes>
      ...
      <Route path="/reset" element={<h1>Reset password stranica</h1>} />
    </Routes>
  );
}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between mb-2 ml-1">
                ...
                <button 
                  type="button" 
                  onClick={() => window.location.href = "/reset"} className="text-xs font-bold text-gray-400 hover:text-uni-brown transition-colors">
