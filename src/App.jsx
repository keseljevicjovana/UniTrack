...
import SluzbaDashboard from "./pages/sluzba/SluzbaDashboard";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/firma/dashboard" element={<ProtectedRoute allowedRole="firma"><FirmaDashboard /></ProtectedRoute>} />
      <Route path="/student/dashboard" element={<ProtectedRoute allowedRole="student"><StudentDashboard /></ProtectedRoute>} />
      <Route path="/sluzba/dashboard" element={<ProtectedRoute allowedRole="studentska_sluzba"><SluzbaDashboard /></ProtectedRoute>} />
